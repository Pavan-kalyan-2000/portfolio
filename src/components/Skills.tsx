...
const Skills: React.FC = () => {
  ...
  const otherSkills = [
    ...
    "CODE-SPLITTING", "LAZY LOADING", "WIREFRAMES & PROTOTYPES", "CMS - CONTENT MANAGEMENT SYSTEM",
    "JQUERY", "BOOTSTRAP", "MYSQL", "JASMINE & KARMA", "DRUPAL", "WINSCP",
    "POSTMAN", "FIGMA", "ADOBE XD", "DEBUGGING", "RESTFUL API'S"
  ];
